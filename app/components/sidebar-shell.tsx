...
import { Home, ClipboardList, Users, DollarSign, Settings, PanelLeftClose } from "lucide-react";
...
export default function SideBarShell({ isAdmin, isMember }: SideBarShellProps) {
	const itemClasses =
		...
		<div className="drawer-side is-drawer-close:overflow-visible">
			...
			>
				<ul className="menu w-full grow pt-8">
					...
					{isAdmin && (
						<li>
							<Link href="/user-management" className={itemClasses} data-tip="User Management">
				...
				{isAdmin && (
					<div className="w-full pb-4">
						<ul className="menu w-full">
							<li>
								<Link href="/admin-panel" className={itemClasses} data-tip="Admin Settings">
